...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans p-8 flex flex-col items-center">
      ...
      {/* Role Selection */}
      <div className="w-full max-w-4xl flex gap-4 justify-center mb-12">
        <button
        ...
        <button
          disabled
          className="px-8 py-4 bg-slate-200 text-slate-400 font-semibold rounded-xl cursor-not-allowed"
        >
          For Students
        </button>
      </div>
